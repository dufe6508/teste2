...
export default function HubFC26({
  ...
  const [tournamentName, setTournamentName] = useState("BRANDÃO CUP FC26");
  const [format, setFormat] = useState("groups_knockout");
  const [numTeams, setNumTeams] = useState<number | string>(24);
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <input
                  ...
                  placeholder="EX: BRANDÃO CUP OFICIAL"
                />
              </div>
            </div>
